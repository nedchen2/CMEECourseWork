...
#after log transformation some of the data distribution will be much more like normal distribution 
hist(genome$BodyWeight, breaks = 100)
hist(genome$logBodyWeight,breaks= 100)

# (11) Nonparametic tests : Not powerful but robust
