...
cor.test(genome$GenomeSize, genome$TotalLength, use='pairwise') #the tvalue in the result: can be seen as a 1-sample t-test, in which the known mean of the sample is 0 (i.e. No correlation)



# allometrix scaling is always the reason for log transformation
...
#The null model y ~ beta1(intercept) 
...
abline(genomeSizeModelDamsel, col='blue') #R is prepared to draw the result of linear model 
