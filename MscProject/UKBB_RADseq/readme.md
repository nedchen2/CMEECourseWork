# **MscPoject** - UKBB RAD seq

## Table of Contents

- [**MscPoject** - UKBB RAD seq](#mscpoject---ukbb-rad-seq)
...
1. This repository contains codes and pipeline for analysising RAD seq data
2. Code naming based on the order of processing
3. You can find all the data used in this project in ../UKBB_Microbimes/data/
