...
parser.add_argument("-s", "--step", help="choose which step to run (1 for alignment to sam, 2 for SamtoBam,  3 for mapping stat, 4,5 for host specific alignment,6 to PercentageCoverage )",
                    default="2")                       
...
def main():
    ...
    if step == str(1):
        ...
        genome_1 = [x for x in genome_list if "GCF_910591885.1_BomTerr_genomic.fna" in x]      
